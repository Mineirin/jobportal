...
<div style="width:820px;border:1px #000000 solid;float:left;margin-left:12px;margin-top:10px;border-radius:5px;">
	<table><tr><td>
			<div style="height:40px;background-color:#0C70A4;border:1px #ffffff solid;float:center;border-radius:5px;margin-left:2px;margin-right:2px;margin-top:2px;margin-bottom:0px;">
				<div style="margin-top:8px;margin-bottom:10px;margin-left:10px;color:#FFFFFF"><font size='5'><b>Retomar a redação na Índia</b></font></div>
			</div></td></tr>
			<tr>
		<td>
		<?php
	...
	<td width="15%" style="background-color:#0C70A4;">Entrega rápida<font size='1'>(Entrega 48 horas)</font></td>
	<td width="15%" style="background-color:#0C70A4;">Entrega rápida<font size='1'>(Entrega 24 horas)</font></td>
