...
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-6">
		<ul>
            <li><i class="fp-ht-bed"></i>Número obrigatório de funcionários: <?php echo $job->REQ_NO_EMPLOYEES; ?></li>
	...
	<div class="col-sm-6">
		<ul> 
            <li><i class="fp-ht-tv"></i>Preferência de sexo <?php echo $job->PREFEREDSEX; ?></li>
...
<div class="col-sm-6 content-body" >
	...
	<ul> 
		<li>Endereço: <?php echo $appl->ADDRESS; ?></li>
		<li>Contato: <?php echo $appl->CONTACTNO;?></li>
		<li>E-mail : <?php echo $appl->EMAILADDRESS;?></li>
		<li>Sexo: <?php echo $appl->SEX;?></li>
		<li>Idade: <?php echo $appl->AGE;?></li> 
	</ul>
	<div class="col-sm-12"> 
		<p>Escolaridade: </p>
