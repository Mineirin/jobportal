...
echo "<font color='#00FF00'>Image  Has been Successfully Deleted!"; ?></td></tr>
  <tr>
    <td width="48" height="21">N°</td>
    <td width="152">Foto:</td>
    
    <td width="141">Data:</td>
...
<td ><a href="managegallery.php?delete=<?php echo $way['slider_id']; ?>" onClick="return confirm('Tem certeza de que deseja deletar esta imagem');">
