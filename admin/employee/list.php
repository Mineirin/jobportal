...
?> 
	<div class="row">
    <div class="col-lg-12">
            <h1 class="page-header">Lista de funcionários  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Adicionar Novo Funcionário</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
