...
<title>Takinamao/Informação do usuário</title>
...
<?php 
		 $ret= mysqli_query("SELECT *FROM user_registration where id='".$_GET['id']."'");
			...
			<tr>
			  <td width="200%" colspan="2"  class="font"><h1><?php echo $row['full_name'];?> 's<span class="font1"> informações &raquo;</span> </h1></td>
  </tr>
			<tr>
			  <td height="37" colspan="2"  class="font"><div align="left">
		          <h2 align="right">Postado em: <span class="comb-value"> <?php echo $row['dop'];?> </span></h2>
		        </div></td>
  </tr>
			  ...
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  <td width="93%" colspan="3" valign="top"><table width="70%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td class="rows"><strong>Nome: </strong></td>
                    ...
                    <tr>
                      <td class="rows"><strong>Numero de Contato:</strong></td>
                    ...
                    <tr>
                      <td class="rows"><strong>Resumo</strong></td>
                      <td class="rows"><span class="comb-value"><a href="http://localhost/jobportal/upload/<?php echo $row['Resume'];?>" class="font1">Resumo</a></span></td>
                      <td>&nbsp;</td>
                    </tr>
