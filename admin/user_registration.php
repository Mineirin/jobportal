...
<!--header-->
   ...
   <!--left-->
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="1%">&nbsp;</td>
        <td width="99%" class="heading5">Gerenciar currículos</td>
      </tr>
      <tr>
...
?>
	  ...
	  <?php echo $_SESSION['del']; ?><?php echo $_SESSION['del']="";?></font></p>
            ...
            <td width="13%"  class="heading">Email</td>
			  <td width="15%"  class="heading">Data</td>
			    <td width="24%"  class="heading">Resumo</td>
