              ...
              <div class="item">
                ...
                <p class="message">
                 ...
                 Eu gostaria de conhecê-lo para discutir as últimas notícias sobre
                  a chegada do novo tema. Eles dizem que vai ser um dos
            ...
            <div class="box-body">
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">Desenhe um bom tema</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="" name="">
                  <span class="text">Torne o tema responsivo</span>
                  <small class="label label-info"><i class="fa fa-clock-o"></i> 4 hs</small>
                  <div class="tools">
                    <i class="fa fa-edit"></i>
                    <i class="fa fa-trash-o"></i>
                  </div>
                ...
                <li>
                  ...
                  <input type="checkbox" value="" name="">
                  <span class="text">Deixe o tema brilhar como uma estrela</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="" name="">
                  <span class="text">Verifique suas mensagens e notificações</span>
            ...
            <div class="box-footer no-border">
              <div class="row">
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Pedidos pelo correio</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
