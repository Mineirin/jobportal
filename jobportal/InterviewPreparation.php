...
<title>PHPGURUKUL Takinamao/InterviewPreparation</title>
...
<img src="images/slider3.png" width="1050"  height="300"/>
</div><!--slider close-->
...
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:255px;border: 1px #CCCCCC solid; margin-left:0px;">
	<li class="topfirst"><a href="JobSeeker.php" style="height:40px;line-height:40px; width:255px; border-radius:15px 15px 0px 0px;border:#000000 0px solid;"><div style="padding-left:0px;"><b> &nbsp;Job Seeker</b></div></a></li>

 <li style="height:2px;width:265px;"></li>
 
	<li class="toplast"><a href="InterviewPreparation.php" style="height:40px;  background-color:#000000; color:#FFFFFF; line-height:40px;width:255px;"><div style="padding-left:0px;"><b> &nbsp;Interview Preparation</b></div></a></li>
