...
<title>PHPGURUKUL Job Portal/ResumeForwardInternational</title>
...
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:255px;border: 1px #CCCCCC solid; margin-left:0px;">
	<li class="topfirst"><a href="ResumeForwardIndia.php" style="height:40px;line-height:40px; width:255px; border-radius:15px 15px 0px 0px; border:#000000 0px solid;">     <div style="padding-left:0px;"><b> &nbsp;Resume Forward India</b></div></a></li>
...
$server=mysqli_query("select * from static where page='ResumeForwardInternational'");
